...
let drinkData = [
    // Bryghusbar
    {picture: "assets/img/bryghus_beer.webp", title: "BryghusBar", link: "bryghus_beer.html"},

    // Bærbar
    {picture: "assets/img/baerbar.webp", title: "Bærbar", link: "baerbar.html"},

     // Cocktailbar
    {picture: "assets/img/cocktailbar.webp", title: "Cocktailbar", link: "cocktailbar.html"},

     // Havebar
    {picture: "assets/img/havebar.webp", title: "Havebar", link: "have.html"},

     // Skovbar
    {picture: "assets/img/skovbar.webp", title: "Skovbar", link: "skov.html"},

    // Vadebar
    {picture: "assets/img/vadebar.webp", title: "Vadebar", link: "vade.html"},

     // Vin og whiskey lounge
    {picture: "assets/img/vin_whiskey_lounge.webp", title: "Vin- og Whiskey loungen", link: "vin.html"},
]
...
let cards2 = document.querySelector(".drikkecards")
     ...
     drinkData.forEach(function(card2) {
        ...
        // Link til drinks sider
        let link = document.createElement("a");
        link.href = card2.link;   
